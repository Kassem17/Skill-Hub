...
export default function AddSkill() {
  const { token, setSkills } = useContext(AppContext);
  ...
  return token ? (
    <div className="flex items-center justify-center min-h-screen w-full bg-gradient-to-br from-blue-100 via-purple-100 to-pink-100 p-4">
      <motion.div
